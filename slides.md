...
<div class="flex items-start gap-6 mb-8">
  ...
  <div class="flex-1">
    <h1 class="text-5xl font-bold text-gray-800 mb-3">SQL vs Les Préjugés</h1>
    <p class="text-xl text-gray-600">Contributrice PostgreSQL reconnue</p>
  </div>
</div>
...
<div class="flex-1 grid grid-cols-2 gap-6">
  <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 shadow-md border-l-4 border-blue-500">
    <h3 class="text-2xl font-bold text-blue-900 mb-4 flex items-center gap-2">
      <span class="text-3xl">⚖️</span> Accusations
    </h3>
    <ul class="space-y-2 text-base text-gray-700">
      <li class="flex items-start gap-2">
        <span class="text-blue-500 mt-1">▸</span>
        <span>Complexité injustifiée</span>
      </li>
      <li class="flex items-start gap-2">
        <span class="text-blue-500 mt-1">▸</span>
        <span>Verbosité excessive</span>
      </li>
      <li class="flex items-start gap-2">
        <span class="text-blue-500 mt-1">▸</span>
        <span>Non moderne, performance douteuse</span>
      </li>
    </ul>
  </div>
  ...
  <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 shadow-md border-l-4 border-purple-500">
    <h3 class="text-2xl font-bold text-purple-900 mb-4 flex items-center gap-2">
      <span class="text-3xl">💡</span> Réalité
    </h3>
    <div class="space-y-3 text-base text-gray-700">
      <div>
        <div class="font-semibold text-blue-700 mb-1">🔧 Possibilités</div>
        <div class="text-sm">Lateral join, CTE, Lag, Mod...</div>
      </div>
      <div>
        <div class="font-semibold text-orange-700 mb-1">⚠️ Attention LLM</div>
        <div class="text-sm">Entraînés sur des requêtes peu qualitatives</div>
      </div>
      <div>
        <div class="font-semibold text-green-700 mb-1">✅ Conclusion</div>
        <div class="text-sm">Le problème n'est pas SQL, c'est la formation</div>
      </div>
    </div>
  </div>
</div>
...
<div class="flex-1 grid grid-cols-2 gap-6">
  <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 shadow-md border-l-4 border-blue-500">
    <h3 class="text-2xl font-bold text-blue-900 mb-4 flex items-center gap-2">
      <span class="text-3xl">🛡️</span> Vulnérabilités
    </h3>
    <ul class="space-y-2 text-base text-gray-700">
      <li class="flex items-start gap-2">
        <span class="text-blue-500 mt-1">▸</span>
        <span>Injection SQL : requêtes préparées, ORM</span>
      </li>
      <li class="flex items-start gap-2">
        <span class="text-blue-500 mt-1">▸</span>
        <span>XSS : strip_tags, HTML Purifier, CSP</span>
      </li>
      <li class="flex items-start gap-2">
        <span class="text-blue-500 mt-1">▸</span>
        <span>SSRF : validation rigoureuse des URL</span>
      </li>
      <li class="flex items-start gap-2">
        <span class="text-blue-500 mt-1">▸</span>
        <span>CSRF : SameSite cookies, référent, POST</span>
      </li>
    </ul>
  </div>
  ...
  <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 shadow-md border-l-4 border-purple-500">
    <h3 class="text-2xl font-bold text-purple-900 mb-4 flex items-center gap-2">
      <span class="text-3xl">⚠️</span> Principe fondamental
    </h3>
    <div class="space-y-3 text-base text-gray-700">
      <div>
        <div class="font-semibold text-red-700 mb-1 text-lg">Ne jamais faire confiance aux données entrantes</div>
      </div>
      <div>
        <div class="font-semibold text-blue-700 mb-1">Bonnes pratiques</div>
        <div class="text-sm">HTTPS, en-têtes sécurité HTTP, Let's Encrypt</div>
      </div>
      <div>
        <div class="font-semibold text-orange-700 mb-1">Impact</div>
        <div class="text-sm">60% des entreprises victimes ferment sous 18 mois</div>
      </div>
    </div>
  </div>
</div>
